...
class SpanMetrics(Metric):
    ...
    def __call__(self,
        ...
        mask = mask.cpu()
        # accuracy includes none_label
        self._total += mask.sum()
        self._correct += ((predictions==gold_labels)*mask.bool()).sum()
    ...
    def get_metric(self, reset=False):
        ...
        accuracy = float(self._correct) / float(self._total + 1e-13)
